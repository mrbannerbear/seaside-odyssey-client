...
<footer class="bg-red-50 p-8">
  <div class="container mx-auto flex flex-wrap justify-around">
    ...
    <div class="w-full sm:w-auto mb-4 sm:mb-0">
      <h4 class="text-lg text-red-900 mb-2">About Us</h4>
    ...
    <div class="w-full sm:w-auto mb-4 sm:mb-0">
      <h4 class="text-lg text-red-900 mb-2">Links</h4>
    ...
    <div class="w-full sm:w-auto mb-4 sm:mb-0">
      <h4 class="text-lg text-red-900 mb-2">Contact Us</h4>
    ...
    <div class="w-full sm:w-auto">
      <h4 class="text-lg text-red-900 mb-2">Follow Us</h4>
      <ul class="list-none p-0">
